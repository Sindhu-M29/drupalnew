...
($context["is_top_level_menu"] ?? null) && CoreExtension::getAttribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "/var/www/html/drupal/web/core/themes/olivero/templates/navigation/menu--primary-menu.html.twig");
    }
